  ...
  document.addEventListener('keydown', function (e) {
    if (e.key === ' ') {
      ...
      if (document.getElementById('notApplicable').checked) {
        // Perform the action for when the checkbox is checked and the spacebar is pressed
        console.log('Not Applicable');
        startInputTimer();
      } else {
        // Perform the action for when the checkbox is not checked and the spacebar is pressed
        console.log('Confidence level:', document.getElementById('slider').value);
        startInputTimer();
      }
    }
  });
